...
const french = {
  ...
  dualSection: "Deux conversations supervisées", dualInstruction: "Sélectionnez deux conversations, puis cliquez sur Démarrer pour les faire communiquer.", conversationWork: "CONVERSATION 1 — WORK", conversationCodex: "CONVERSATION 2 — CODEX", refreshConversations: "Actualiser les conversations", searchConversations: "Rechercher par nom", projectFilter: "Filtrer par projet", chooseConversation: "Choisir une conversation", noConversations: "Aucune conversation compatible détectée.", selectedConversation: "Conversation sélectionnée", firstSpeaker: "Qui commence ?", workStarts: "WORK commence", codexStarts: "CODEX commence", initialObjective: "Objectif de la communication", initialObjectivePlaceholder: "Objectif facultatif", dualMaxCycles: "Cycles maximum", dualStart: "Démarrer la communication", dualPause: "Pause après la réponse actuelle", dualResume: "Reprendre la communication", dualStop: "Arrêter proprement", dualClear: "Effacer uniquement l’affichage", dualStatus: "État du dialogue", dualReadOnly: "Lecture seule : les conversations peuvent analyser et répondre, mais ne peuvent pas modifier les fichiers.", discoveryFailed: "Impossible de détecter les conversations.", duplicateConversation: "Sélectionnez deux conversations différentes.", projectsDifferent: "Les deux conversations appartiennent à des projets différents.", conversationUnavailable: "Cette conversation n’est plus disponible.", pairSaved: "Le couple de conversations est mémorisé.", noSavedPair: "Aucun couple mémorisé.", loaded: "ouverte", available: "enregistrée", unavailable: "indisponible", lastActivity: "Dernière activité", provider: "Fournisseur", source: "Source", cycleLimitReached: "Limite de cycles atteinte.", dualReady: "Couple prêt. Vérifiez la pré-vérification puis démarrez.", dualStarted: "Communication démarrée.", dualPaused: "Pause demandée après la réponse actuelle.", dualResumed: "Communication reprise.", dualStopped: "Communication arrêtée et transports nettoyés.", dualSavedPair: "Couple mémorisé", dualNoSelection: "Choisissez une conversation dans chaque carte.", dualCycle: "Cycle {cycle}", dualMessage: "Message de {speaker}",
} as const;

type DictionaryKey = keyof typeof french;
type BridgeKey = "communicationStatus" | "workConnection" | "mcpConnection" | "codexLocal" | "communicationMode" | "realWorkHost" | "localSimulation" | "bridgeCleanup" | "workAuthManaged" | "mcpConnected" | "mcpNotConnected" | "codexReady" | "codexAuthRequired" | "codexError" | "bindingSection" | "bindingEphemeral" | "bindingPersistent" | "bindingAlias" | "bindingThreadId" | "bindingAdd" | "bindingValidate" | "bindingDisable" | "bindingRemove" | "bindingState" | "bindingHelp" | "bindingPreserved" | "bindingNoEntries";
...
const dualRussian: Pick<Dictionary, "dualSection" | "dualInstruction" | "conversationWork" | "conversationCodex" | "refreshConversations" | "searchConversations" | "projectFilter" | "chooseConversation" | "noConversations" | "selectedConversation" | "firstSpeaker" | "workStarts" | "codexStarts" | "initialObjective" | "initialObjectivePlaceholder" | "dualMaxCycles" | "dualStart" | "dualPause" | "dualResume" | "dualStop" | "dualClear" | "dualStatus" | "dualReadOnly" | "discoveryFailed" | "duplicateConversation" | "projectsDifferent" | "conversationUnavailable" | "pairSaved" | "noSavedPair" | "loaded" | "available" | "unavailable" | "lastActivity" | "provider" | "source" | "cycleLimitReached" | "dualReady" | "dualStarted" | "dualPaused" | "dualResumed" | "dualStopped" | "dualSavedPair" | "dualNoSelection" | "dualCycle" | "dualMessage"> = {
  dualSection: "Надзор за двумя диалогами", dualInstruction: "Выберите два диалога и нажмите «Запустить», чтобы связать их.", conversationWork: "ДИАЛОГ 1 — WORK", conversationCodex: "ДИАЛОГ 2 — CODEX", refreshConversations: "Обновить диалоги", searchConversations: "Поиск по названию", projectFilter: "Фильтр по проекту", chooseConversation: "Выберите диалог", noConversations: "Совместимые диалоги не найдены.", selectedConversation: "Выбранный диалог", firstSpeaker: "Кто начинает?", workStarts: "Начинает WORK", codexStarts: "Начинает CODEX", initialObjective: "Цель общения", initialObjectivePlaceholder: "Необязательная цель", dualMaxCycles: "Максимум циклов", dualStart: "Запустить общение", dualPause: "Пауза после текущего ответа", dualResume: "Продолжить общение", dualStop: "Остановить корректно", dualClear: "Очистить только отображение", dualStatus: "Состояние диалога", dualReadOnly: "Только чтение: диалоги могут анализировать и отвечать, но не изменяют файлы.", discoveryFailed: "Не удалось обнаружить диалоги.", duplicateConversation: "Выберите два разных диалога.", projectsDifferent: "Диалоги относятся к разным проектам.", conversationUnavailable: "Этот диалог больше недоступен.", pairSaved: "Пара диалогов сохранена.", noSavedPair: "Нет сохранённой пары.", loaded: "открыт", available: "сохранён", unavailable: "недоступен", lastActivity: "Последняя активность", provider: "Поставщик", source: "Источник", cycleLimitReached: "Достигнут предел циклов.", dualReady: "Пара готова. Проверьте конфигурацию и запустите.", dualStarted: "Общение запущено.", dualPaused: "Пауза запрошена после текущего ответа.", dualResumed: "Общение продолжено.", dualStopped: "Общение остановлено, транспорт очищен.", dualSavedPair: "Сохранить пару", dualNoSelection: "Выберите диалог в каждой карточке.", dualCycle: "Цикл {cycle}", dualMessage: "Сообщение от {speaker}",
};
...
const russian: Dictionary = {
  ...
  advanced: "Расширенные", close: "Закрыть", ...dualRussian,
...
const bridgeTranslations: Record<Locale, Record<BridgeKey, string>> = {
  "fr-FR": { communicationStatus: "Communication", workConnection: "WORK", mcpConnection: "ChatCOM MCP", codexLocal: "Codex local", communicationMode: "Mode de communication", realWorkHost: "REAL_WORK_HOST", localSimulation: "LOCAL_SIMULATION", bridgeCleanup: "Nettoyage", workAuthManaged: "Connexion gérée par l’application OpenAI", mcpConnected: "CONNECTED", mcpNotConnected: "NOT_CONNECTED", codexReady: "READY", codexAuthRequired: "AUTH_REQUIRED", codexError: "ERROR", bindingSection: "Liaisons Codex locales", bindingEphemeral: "Conversation temporaire", bindingPersistent: "Conversation Codex liée", bindingAlias: "Alias lisible", bindingThreadId: "Identifiant exact du fil", bindingAdd: "Ajouter une liaison", bindingValidate: "Valider", bindingDisable: "Désactiver", bindingRemove: "Supprimer", bindingState: "État", bindingHelp: "La liaison utilise un identifiant exact. Le fil lié est conservé après le nettoyage.", bindingPreserved: "Fil conservé", bindingNoEntries: "Aucune liaison locale." },
  "en-US": { communicationStatus: "Communication", workConnection: "WORK", mcpConnection: "ChatCOM MCP", codexLocal: "Local Codex", communicationMode: "Communication mode", realWorkHost: "REAL_WORK_HOST", localSimulation: "LOCAL_SIMULATION", bridgeCleanup: "Cleanup", workAuthManaged: "Connection managed by the OpenAI application", mcpConnected: "CONNECTED", mcpNotConnected: "NOT_CONNECTED", codexReady: "READY", codexAuthRequired: "AUTH_REQUIRED", codexError: "ERROR", bindingSection: "Local Codex bindings", bindingEphemeral: "Temporary conversation", bindingPersistent: "Bound Codex conversation", bindingAlias: "Readable alias", bindingThreadId: "Exact thread identifier", bindingAdd: "Add binding", bindingValidate: "Validate", bindingDisable: "Disable", bindingRemove: "Remove", bindingState: "State", bindingHelp: "Bindings use an exact identifier. The bound thread is preserved after cleanup.", bindingPreserved: "Thread preserved", bindingNoEntries: "No local bindings." },
  "zh-CN": { communicationStatus: "通信", workConnection: "WORK", mcpConnection: "ChatCOM MCP", codexLocal: "本地 Codex", communicationMode: "通信模式", realWorkHost: "REAL_WORK_HOST", localSimulation: "LOCAL_SIMULATION", bridgeCleanup: "清理", workAuthManaged: "连接由 OpenAI 应用管理", mcpConnected: "CONNECTED", mcpNotConnected: "NOT_CONNECTED", codexReady: "READY", codexAuthRequired: "AUTH_REQUIRED", codexError: "ERROR", bindingSection: "本地 Codex 绑定", bindingEphemeral: "临时对话", bindingPersistent: "已绑定的 Codex 对话", bindingAlias: "可读别名", bindingThreadId: "准确的线程标识符", bindingAdd: "添加绑定", bindingValidate: "验证", bindingDisable: "停用", bindingRemove: "删除", bindingState: "状态", bindingHelp: "绑定使用准确的标识符。清理后会保留已绑定的线程。", bindingPreserved: "线程已保留", bindingNoEntries: "没有本地绑定。" },
  "ru-RU": { communicationStatus: "Связь", workConnection: "WORK", mcpConnection: "ChatCOM MCP", codexLocal: "Локальный Codex", communicationMode: "Режим связи", realWorkHost: "REAL_WORK_HOST", localSimulation: "LOCAL_SIMULATION", bridgeCleanup: "Очистка", workAuthManaged: "Подключение управляется приложением OpenAI", mcpConnected: "CONNECTED", mcpNotConnected: "NOT_CONNECTED", codexReady: "READY", codexAuthRequired: "AUTH_REQUIRED", codexError: "ERROR", bindingSection: "Локальные привязки Codex", bindingEphemeral: "Временный диалог", bindingPersistent: "Привязанный диалог Codex", bindingAlias: "Понятный псевдоним", bindingThreadId: "Точный идентификатор ветки", bindingAdd: "Добавить привязку", bindingValidate: "Проверить", bindingDisable: "Отключить", bindingRemove: "Удалить", bindingState: "Состояние", bindingHelp: "Привязка использует точный идентификатор. После очистки ветка сохраняется.", bindingPreserved: "Ветка сохранена", bindingNoEntries: "Локальных привязок нет." },
};
