...
export function parsePreferences(raw: unknown, systemLocale?: string, appVersion = "1.0.0-rc.4"): DesktopPreferences {
...
export function migratePreferences(raw: unknown, systemLocale?: string, appVersion = "1.0.0-rc.4"): DesktopPreferences { return parsePreferences(raw, systemLocale, appVersion); }
