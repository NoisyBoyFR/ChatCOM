...
export const DEFAULT_PREFERENCES: DesktopPreferences = { schemaVersion: PREFERENCES_SCHEMA_VERSION, language: "fr-FR", theme: "system", windowMode: "normal", textSize: "normal", reduceMotion: false, autoScroll: true, maxCycles: 5 };
...
export function parsePreferences(raw: unknown, systemLocale?: string): DesktopPreferences {
...
export function migratePreferences(raw: unknown, systemLocale?: string): DesktopPreferences { return parsePreferences(raw, systemLocale); }
